	        ...
	        <div className="relative container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			        ...
			        <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				        <Link to="/" className="px-8 py-3 text-lg font-projectFont font-semibold rounded-lg shadow-xl bg-white text-blue hover:bg-blue hover:scale-105 hover:text-white duration-200 active:bg-blue-200">Job Search</Link>
			        </div>
		        </div>
	        </div>
        </section>
