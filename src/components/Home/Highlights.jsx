...
function Highlights() {
  return (
    <div className='w-full py-[80px] px-4 bg-white'>
      <div>
        <h1 className='text-blue md:text-3xl sm:text-2xl text-xl font-bold text-center pb-4'>Highlights @ JAP</h1>
      </div>
      <div className='max-w-[1240px] mx-8 md:mx-auto grid md:grid-cols-4 gap-2 md:gap-8 bg-orange-200]'>
        <div className='bg-orange-100 w-full shadow-2xl flex flex-col px-4 py-6 my-4 rounded-xl hover:scale-105 duration-300'>
