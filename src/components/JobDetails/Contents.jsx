...
function Content() {
  ...
  <div className='w-full py-[80px] bg-white px-10 pt-6 pb-8'>
    <figure className='px-8 pt-6 pb-8 mb-4'><img src="https://www.sparrowsph.my/image/data/theme/Entrepreneurs%20Listed/vitrox-chu-logo_030922231458.jpg" alt="Company" img-height='1px'/></figure> 
    <div className='shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        <h1 className='text-[#F68B1F] font-projectFont md:text-3xl sm:text-2xl text-2xl font-bold text-left pb-4'>Job Title</h1>
        <h3 className='text-[#311B92] font-projectFont md:text-xl sm:text-l text-m font-medium text-left pb-4'>Company Name</h3>
    ...
    <h3 className='font-projectFont text-[#311B92] md:text-xl sm:text-l text-m font-bold text-left pb-4'>Job Details</h3>
