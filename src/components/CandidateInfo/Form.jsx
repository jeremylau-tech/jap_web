        ...
        <form novalidate="" action="" className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3 justify-center">
				<div className="col-span-full sm:col-span-3">
					<label for="first-name" className="font-projectFontfont-medium text-sm">First Name</label>
					<input id="first-name" type="text" placeholder="First name" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400 " />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label for="last-name" className="font-projectFont font-medium text-sm">Last Name</label>
					<input id="last-name" type="text" placeholder="Last name" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label for="qualification" className="font-projectFont font-medium text-sm">Gender</label>
                    <select className="w-full p-2 font-projectFont text-[#64748b] text-base bg-white border rounded-md shadow-sm  focus:ring focus:ring-opacity-75 focus:border-blue-400">
				...
				<div className="col-span-full sm:col-span-3">
					...
					<input id="contact" type="text" placeholder="with country code (60123456789)" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
				<div className="col-span-full">
					<label for="email" className="font-projectFont font-medium text-sm">Email</label>
					<input id="email" type="email" placeholder="Email" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label for="country" className="font-projectFont font-medium text-sm">Country</label>
					<input id="country" type="text" placeholder="" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label for="state" className="font-projectFont font-medium text-sm">State / Province</label>
					<input id="state" type="text" placeholder="" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label for="city" className="font-projectFont font-medium text-sm">City</label>
					<input id="city" type="text" placeholder="" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
			</div>
		    </fieldset>
		    <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-lg shadow-xl text-black">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                <div className="col-span-full">
					...
					<input id="university" type="text" placeholder="University / Institute name" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75  focus:ring-blue-400" />
				</div>
				<div className="col-span-full sm:col-span-3">
                ...
                <div className="col-span-full sm:col-span-3">
					...
					<input id="studyField" type="text" placeholder="" className="w-full font-projectFont rounded-md focus:ring focus:ring-opacity-75 focus:ring-blue-400" />
				</div>
			</div>
		    </fieldset>
	    </form>
